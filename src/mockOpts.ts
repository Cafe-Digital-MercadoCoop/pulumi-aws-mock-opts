    ...
    newResource: function(type, name, inputs) {
        ...
        case 'aws:eks/cluster:Cluster':
            return {
                ...
                state: {
                    ...
                    roleArn: 'arn:aws:iam::123456789012:role/mercado-eks-import-dev20201101235959000000000000',
        ...
        case 'kubernetes':
            return {
                ...
                id: inputs.name + '-id',
                state: {
                    cluster: 'mercado-eks-import-dev',
                    kubeconfig: '{"kind":"Config","apiVersion":"v1","preferences":{},"clusters":[{"name":"mercado-eks-import-dev","cluster":{"server":"https://AAAA0000BBBB1111CCCC2222DDDD3333.gr7.us-east-1.eks.amazonaws.com","certificate-authority-data":"LLKL=Qalaszz1231kaadadcad12213d"}}],"users":[{"name":"arn:aws:iam::123456789012:role/mercado-eks-import-dev20201101235959000000000000","user":{"exec":{"command":"aws","args":["--region","us-east-1","eks","get-token","--cluster-name","mercado-eks-import-dev"],"env":[{"name":"AWS_PROFILE","value":"profile-name"}],"apiVersion":"client.authentication.k8s.io/v1alpha1"}}}],"contexts":[{"name":"arn:aws:iam::123456789012:role/mercado-eks-import-dev20201101235959000000000000","context":{"cluster":"arn:aws:iam::123456789012:role/mercado-eks-import-dev20201101235959000000000000","user":"arn:aws:iam::123456789012:role/mercado-eks-import-dev20201113124404311700000002"}}],"current-context":"arn:aws:iam::123456789012:role/mercado-eks-import-dev20201101235959000000000000"}',
                },
            };
